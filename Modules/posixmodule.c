           ...
           after removing support of non-bytes buffer objects. */
            if (PyErr_WarnFormat(PyExc_DeprecationWarning, 1,
                                 ...
                                 path->allow_fd && path->nullable ? "string, bytes, os.PathLike, "
                                                                    "integer or None"
                                                                  : path->allow_fd ? "string, bytes, os.PathLike or integer" : path->nullable ? "string, bytes, os.PathLike or None" : "string, bytes or os.PathLike",
                                 _PyType_Name(Py_TYPE(o))))
            {
                goto error_exit;
            }
...
#endif
    Py_END_ALLOW_THREADS if (result < 0) return path_error(path);
#endif /* MS_WINDOWS */
        Py_RETURN_NONE;
    }
...
[clinic start generated code]*/
    ...
    _check_dirW(LPCWSTR src, LPCWSTR dest)
    {
        ...
        return (
            GetFileAttributesExW(src_resolved, GetFileExInfoStandard, &src_info) && src_info.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY);
    }
#endif
...
[clinic start generated code]*/
    ...
    Py_BEGIN_ALLOW_THREADS if (!inheritable)
...
#endif
        _Py_END_SUPPRESS_IPH
            Py_END_ALLOW_THREADS if (result < 0)
                posix_error();
...
#if (defined(HAVE_SENDFILE) && (defined(__FreeBSD__) || defined(__DragonFly__) || defined(__APPLE__))) || defined(HAVE_READV) || defined(HAVE_PREADV) || defined(HAVE_PREADV2) || defined(HAVE_WRITEV) || defined(HAVE_PWRITEV) || defined(HAVE_PWRITEV2)
    static int
...
#if USE_UNICODE_WCHAR_CACHE
        _Py_COMP_DIAG_PUSH
            _Py_COMP_DIAG_IGNORE_DEPR_DECLS const wchar_t *path = PyUnicode_AsUnicode(ub);
        _Py_COMP_DIAG_POP
#else  /* USE_UNICODE_WCHAR_CACHE */
    ...
    /*[clinic end generated code: output=156bb3a72162440e input=3ee7b872ae8649f0]*/
    {
        ...
        if (!self->got_file_index)
        {
...
#if USE_UNICODE_WCHAR_CACHE
            _Py_COMP_DIAG_PUSH
                _Py_COMP_DIAG_IGNORE_DEPR_DECLS const wchar_t *path = PyUnicode_AsUnicode(unicode);
            ...
            PyMem_Free(path);
                ...
                if (result != 0) return path_object_error(self->path);
                ...
                OS_DIRENTRY_IS_SYMLINK_METHODDEF
                    OS_DIRENTRY_STAT_METHODDEF
                        OS_DIRENTRY_INODE_METHODDEF
                            OS_DIRENTRY___FSPATH___METHODDEF{"__class_getitem__", (PyCFunction)Py_GenericAlias,
...
[clinic start generated code]*/
    ...
    /*[clinic end generated code: output=80b025daebb5d683 input=1de3e6c13a5808c8]*/
    {
       ...
       loaded. */
        Py_BEGIN_ALLOW_THREADS if (!(hKernel32 = GetModuleHandleW(L"kernel32")) ||
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    OS_MEMFD_CREATE_METHODDEF
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        OS__ADD_DLL_DIRECTORY_METHODDEF
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            OS__REMOVE_DLL_DIRECTORY_METHODDEF
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                OS_WAITSTATUS_TO_EXITCODE_METHODDEF{NULL, NULL} /* Sentinel */
    };
...
#ifdef MS_WINDOWS
        if (PyModule_AddIntConstant(m, "_LOAD_LIBRARY_SEARCH_DEFAULT_DIRS", LOAD_LIBRARY_SEARCH_DEFAULT_DIRS))
            return -1;
        if (PyModule_AddIntConstant(m, "_LOAD_LIBRARY_SEARCH_APPLICATION_DIR", LOAD_LIBRARY_SEARCH_APPLICATION_DIR))
            return -1;
        if (PyModule_AddIntConstant(m, "_LOAD_LIBRARY_SEARCH_SYSTEM32", LOAD_LIBRARY_SEARCH_SYSTEM32))
            return -1;
        if (PyModule_AddIntConstant(m, "_LOAD_LIBRARY_SEARCH_USER_DIRS", LOAD_LIBRARY_SEARCH_USER_DIRS))
            return -1;
        if (PyModule_AddIntConstant(m, "_LOAD_LIBRARY_SEARCH_DLL_LOAD_DIR", LOAD_LIBRARY_SEARCH_DLL_LOAD_DIR))
            return -1;
#endif
