...
# For whatever reasons, zlib gives irregular results or
...
def main():
    ...
    parser.add_option(
        "", "--latclient", action="store", dest="latclient", default=None, help=SUPPRESS_HELP
    )
    parser.add_option(
        "", "--bwclient", action="store", dest="bwclient", default=None, help=SUPPRESS_HELP
    )
